...
pub fn main(init: std.process.Init.Minimal) !void {
    ...
    var init_opts: game_mod.InitOptions = .{
        ...
        .land_claim_count = cfg.land_claim_count,
        .land_claim_dead_zone = cfg.land_claim_dead_zone,
        .land_claim_offline_delay = cfg.land_claim_offline_delay,
        .land_claim_decay_mode = cfg.land_claim_decay_mode,
