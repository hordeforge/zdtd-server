...
pub fn loadAssets(self: *Game, allocator: std.mem.Allocator, opts: game_mod.InitOptions) !void {
    ...
    if (logged("entityclasses.xml", assets_entities.tryLoad(allocator, opts.game_dir, opts.config_dir))) |et| {
        ...
        self.sim.setClassDef(1, .{
            ...
            .chase_speed_day = zdef.chase_speed_day,
            ...
            .sleeper_wake_near_max = zdef.sleeper_wake_near_max,
            .sleeper_wake_far_min = zdef.sleeper_wake_far_min,
            .sleeper_wake_far_max = zdef.sleeper_wake_far_max,
        ...
        self.sim.setClassDef(7, .{
            ...
            .chase_speed_day = adef.chase_speed_day,
            .wander_speed = adef.wander_speed,
            .wander_speed_night = adef.wander_speed_night,
            .move_speed_rand_min = adef.move_speed_rand_min,
            ...
            .sleeper_wake_near_max = adef.sleeper_wake_near_max,
            .sleeper_wake_far_min = adef.sleeper_wake_far_min,
    ...
    if (logged("entitygroups.xml", assets_entitygroups.tryLoad(allocator, opts.game_dir, opts.config_dir))) |gt| {
        ...
        while (zslot < 12) : (pick_seed += 1) {
            ...
            self.sim.setClassDef(@intCast(zslot), .{
                ...
                .chase_speed_day = def.chase_speed_day,
                .wander_speed = def.wander_speed,
                .wander_speed_night = def.wander_speed_night,
                .move_speed_rand_min = def.move_speed_rand_min,
                ...
                .sleeper_wake_near_max = def.sleeper_wake_near_max,
                .sleeper_wake_far_min = def.sleeper_wake_far_min,
