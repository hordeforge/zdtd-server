...
pub const isUnreliablePackage = delivery_policy.isUnreliablePackage;
pub const isCompressedPackage = delivery_policy.isCompressedPackage;
pub const isDroppablePackage = delivery_policy.isDroppablePackage;
