...
pub const admin_help_index = [_]admin_cmds.HelpEntry{
    ...
    .{ .names = "commandpermission, cp", .description = "set/query per-command permission levels" },
    ...
    .{ .names = "list, players", .description = "zdtd: alias of listplayers" },
    .{ .names = "plugin", .description = "zdtd: list/reload Wasm plugin modules" },
    .{ .names = "listplayers, lp", .description = "lists all players" },
    .{ .names = "loglevel", .description = "get/set the runtime log level (0..4)" },
