...
| `CameraRestrictionMode` | camera_restriction_mode | src/server/config.zig | 541 |
| `DeathPenalty` | death_penalty | src/server/config.zig | 542 |
| `LandClaimSize` | land_claim_size | src/server/config.zig | 543 |
| `LandClaimOnlineDurabilityModifier` | land_claim_online_durability_modifier | src/server/config.zig | 549 |
| `LandClaimOfflineDurabilityModifier` | land_claim_offline_durability_modifier | src/server/config.zig | 551 |
| `LandClaimExpiryDays` | land_claim_expiry_days | src/server/config.zig | 553 |
| `LandClaimCount` | land_claim_count | src/server/config.zig | 555 |
| `LandClaimDeadZone` | land_claim_dead_zone | src/server/config.zig | 557 |
| `LandClaimOfflineDelay` | land_claim_offline_delay | src/server/config.zig | 559 |
| `LandClaimDecayMode` | land_claim_decay_mode | src/server/config.zig | 561 |
| `LootRespawnDays` | loot_respawn_days | src/server/config.zig | 563 |
...
| `ZdtdAuthorityMode` | authority_mode | src/server/config.zig | 565 |
