...
| `packages.zig` | 155 | partial: audited by `--lines` section, since no small filter set covers the whole file. Lines 480-1100 done (36 pairs, 0 survivors after the fixes): the PlayerId join body, PlayerSpawnedInWorld, lastSpawnPosition, PosAndRot, RelPosAndRot, EntitySpeeds. 119 pairs above line 1100 unaudited |
