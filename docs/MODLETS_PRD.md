...
`../7dtd-research/docs/mod-loading.md` (ModManager / XmlPatcher / SendXmlsToClient),
`../7dtd-research/docs/inventories/xmlsToLoad.md` (49-row config table),
`../7dtd-research/docs/protocol-packages.md` (NetPackageConfigFile IL=25,
...
2. Full coverage of the **verified stock `XmlPatchMethods` catalog**
   (`../7dtd-research/docs/mod-loading.md` §5.3): set/setattribute
...
- Fixture modlet under `assets/fixtures/` (adds one block, one item, one recipe,
  ...
  smoke.
- Docs: this PRD, an implementation plan, `docs/INDEX.md` row, provenance rows,
...
All from `../7dtd-research/docs`; not re-derived here.
...
- `docs/MODLETS_PLAN.md`: task breakdown, order, verify points (this PRD's §8).
- `docs/INDEX.md`: add this PRD + plan.
