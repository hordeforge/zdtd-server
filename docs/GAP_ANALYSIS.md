...
canonical WORKS/PARTIAL/MISSING tag (142/140/47) and the scorecard rows below
...
| **Total** | **142** | **140** | **47** | **329** | Core loop playable with stakes; content fidelity and persistence are the gap |
