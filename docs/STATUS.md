...
| Automated in-client playtest | **PASS join + demo partial (2026-08-03)** | V3.1.0 pin + admin fixture parity. Latest peak `playtest-zdtd` → **pass=81 fail=2** (2026-08-04h). 20260804i: **eat_food** + **ranged_shot** PASS (fixture force-dec + SetHeldMeta); power suite intermittent float flake (76/7 that run). See [PLAYTEST_V310_20260803.md](PLAYTEST_V310_20260803.md). |
