...
| Automated in-client playtest | **PASS join + demo partial (2026-08-03)** | V3.1.0 pin + admin fixture parity. Latest `playtest-zdtd` → **pass=77 fail=6** (2026-08-04d; CGO 63/39 PASS, dig/place/loot/craft PASS). Residual: block dmg Y, food consume, generator/wire place, intermittent zombie target. See [PLAYTEST_V310_20260803.md](PLAYTEST_V310_20260803.md). |
