...
**Ships as:** a Wasm plugin module (ADR 0020 / ADR 0030) + a minimal host
transport bridge.
...
- Documentation: this PRD, ADR 0031 (guest/host boundary, transport choice,
  tool surface), design plan (`docs/MCP_DESIGN.md`).
...
- As an **operator**, I add `mods/zdtd_mcp.wasm` to `[plugin] modules`; an MCP
...
## 10. Milestones (see MCP_DESIGN.md)
