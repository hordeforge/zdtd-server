...
`../../7dtd-engine-research/docs/content/minevents.md` section 7.0.
...
**Why:** `../../7dtd-engine-research/docs/entities/stealth-smell.md` documents a
...
**Grounding:** `../../7dtd-engine-research/docs/entities/stealth-smell.md` in full; cross-check
...
**Why:** `../../7dtd-engine-research/docs/entities/raycast-pathing.md` section 6b is the
...
**Grounding:** `../../7dtd-engine-research/docs/entities/raycast-pathing.md` section 6b (the
state machine, including the state table and transition diagram) and
`../../7dtd-engine-research/docs/gameplay/vehicles-drones-turrets.md` section 5
(persistence/sync).
...
**Grounding:** `../../7dtd-engine-research/docs/content/game-events.md` in full, especially
...
**Why:** `../../7dtd-engine-research/docs/content/quests-challenges.md` sections 6-9
...
**Grounding:** `../../7dtd-engine-research/docs/content/quests-challenges.md` sections 6-9 in
full.
...
**What's confirmed:** `../../7dtd-engine-research/docs/gameplay/crafting-recipes.md` section 2
...
**Grounding:** `../../7dtd-engine-research/docs/gameplay/crafting-recipes.md` section 2;
...
`../../7dtd-engine-research/docs/gameplay/crafting-recipes.md` if picked up), not an
...
**Grounding:** `../../7dtd-engine-research/docs/gameplay/map-objects.md` section 8.
...
**Why:** `../../7dtd-engine-research/docs/world/block-shapes.md` section 7: stock's
...
**Grounding:** `../../7dtd-engine-research/docs/world/block-shapes.md` section 7.
...
**Why:** `../../7dtd-engine-research/docs/admin/server-lifecycle.md` section 6.1: stock's
...
**Grounding:** `../../7dtd-engine-research/docs/admin/server-lifecycle.md` section 6.1.
...
**Grounding:** `../../7dtd-engine-research/docs/meta/dedicated-misc-systems.md`
