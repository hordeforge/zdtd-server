...
**world** blobs blindly (AGENTS rule 17). Inventory: [ADR 0007](adr/0007-player-inventory-c2s-trust.md). Every place
this rule makes zdtd behave differently from stock is listed with its cost in
