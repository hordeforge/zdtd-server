...
- Annotate write/read order vs `../../7dtd-engine-research/docs/world/world-chunks.md` + IL.  
...
| [../../7dtd-engine-research/docs/network/protocol.md](../../7dtd-engine-research/docs/network/protocol.md) | Wire |
