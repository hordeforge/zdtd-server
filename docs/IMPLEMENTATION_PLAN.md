...
- Annotate write/read order vs `../../7dtd-engine-research/docs/world-chunks.md` + IL.  
...
| [../../7dtd-engine-research/docs/protocol.md](../../7dtd-engine-research/docs/protocol.md) | Wire |
