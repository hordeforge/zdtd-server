...
drift-checked by `make check`) is the development line; `v0.6.0` is the latest
release. A minor bump may land any time and does not signal a stable API
commitment. Product tags: `v0.1.0`,
`v0.1.1`, `v0.3.0`, `v0.4.0`, `v0.5.0`, `v0.6.0`. (`v3.1.0` points at the same commit as `v0.1.1` and names
