...
| Subject references: [ASSETS.md](ASSETS.md), [GAME_OPTIONS.md](GAME_OPTIONS.md), [RULES_CONFIG.md](RULES_CONFIG.md), [MAPS.md](MAPS.md), [WORLDGEN.md](WORLDGEN.md), [GAMEPLAY.md](GAMEPLAY.md), [STATE_MACHINES.md](STATE_MACHINES.md), [AUTHORITY.md](AUTHORITY.md), [THREAT_MODEL.md](THREAT_MODEL.md), [APM.md](APM.md), [WEBUI.md](WEBUI.md), [SCALE.md](SCALE.md), [RE_GAP_CLOSURE.md](RE_GAP_CLOSURE.md) | the reference for that one subject | restating another subject's reference |
