...
`../../7dtd-engine-research/docs/network/protocol-packages.md`: `NetPackageTileEntity` widened,
...
| `../../7dtd-engine-research/docs/network/protocol-packages.md` | Per-package wire bodies + census |
