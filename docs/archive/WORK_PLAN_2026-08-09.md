...
`../../../7dtd-engine-research/docs/loot-economy.md`, updated 2026-08-06).
...
recorded in `../../../7dtd-engine-research/docs/progression.md`.
...
`../../../7dtd-engine-research/docs/quests-challenges.md` (2026-08-06).
...
`../../../7dtd-engine-research/docs/aidirector.md` (2026-08-06).
...
`../../../7dtd-engine-research/docs/protocol-packages.md`); the transport poll it would
