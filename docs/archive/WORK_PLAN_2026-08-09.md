...
1. Read the task's **Grounding** first. Any claim about stock behaviour must be
   checked against the IL dump at `$HOME/.cache/zdtd-scratch/asm.il`
...
`../../../7dtd-engine-research/docs/gameplay/loot-economy.md`, updated 2026-08-06).
...
recorded in `../../../7dtd-engine-research/docs/gameplay/progression.md`.
...
`../../../7dtd-engine-research/docs/content/quests-challenges.md` (2026-08-06).
...
`../../../7dtd-engine-research/docs/entities/aidirector.md` (2026-08-06).
...
(`../../../7dtd-engine-research/docs/inventories/netpackages.md`,
`../../../7dtd-engine-research/docs/network/protocol-packages.md`); the transport poll it would
...
[HARDCODE_AUDIT.md](HARDCODE_AUDIT_2026-08-08.md) exists to catch.
