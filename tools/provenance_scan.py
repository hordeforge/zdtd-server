...
def main():
    ...
    #     29 of 79 builders in packages.zig still carry no citation (measured
    #     2026-09-04, lowered from 34 the same day); that backlog is not a reason
