...
<tr><th scope="row">Wasm plugin surface</th><td>16 verdict/event hooks + sense/queue/query; 6 reference modules</td><td>Z: ADR 0020, PLUGIN_DEV.md expressibility audit · mods/ (bot, zdtd_killfeed, zdtd_pvp, zdtd_questgate, zdtd_craftgate, zdtd_lootgate)</td></tr>
