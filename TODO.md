...
| [docs/GAP_ANALYSIS.md](docs/GAP_ANALYSIS.md) | Gap inventory · 298 features · **0 MISSING** |
...
(STATUS wins on conflict). The scorecard is 296 WORKS / 2 PARTIAL / 0 MISSING;
